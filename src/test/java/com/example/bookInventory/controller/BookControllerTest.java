...
class BookControllerTest {
    ...
    @Test
    @DisplayName("** JUnit test: get all books from Book Ctrl. **")
    ...
    @Test
    @DisplayName("** JUnit test: get book by ID from Book Ctrl. **")
    ...
    @Test
    @DisplayName("** JUnit test: save book from Book Ctrl. **")
    ...
    @Test
    @DisplayName("** JUnit test: update book from Book Ctrl. **")
    void updateBook() throws Exception {
        ...
        updateBook1.setTitle("Updated Book 3");
        updateBook1.setAuthor("John");
    ...
    @Test
    @DisplayName("** JUnit test: delete book from Book Ctrl. **")
